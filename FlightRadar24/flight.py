...
class Flight(object):
    ...
    def set_flight_details(self, flight_details):
        ...
        if airport is not None:
            ...
            if dest_aiport is not None:
                # Get destination airport timezone.
                dest_aiport_timezone = dest_aiport.get("timezone", dict())

                # Destination airport timezone.
                if dest_aiport_timezone is not None:
                ...
                if dest_aiport_position is not None:
                    ...
                    if dest_aiport_country is not None:
            ...
            if orig_aiport is not None:                
                ...
                if orig_aiport_country is not None:
                ...
                if orig_aiport_code is not None:
                ...
                if orig_aiport_info is not None:
                ...
                if orig_aiport_timezone is not None:
